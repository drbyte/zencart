...
if (!defined('IS_ADMIN_FLAG')) {
  die('Illegal Access');
    ...
    $zco_notifier->notify('NOTIFY_ADMIN_COLLECT_INFO', 'document_product', $pInfo, $cInfo);
...
<?php
  $zco_notifier->notify('NOTIFY_ADMIN_COLLECT_INFO_ADDITIONAL_FIELDS', 'document_product', $pInfo, $cInfo);
?>
        </table></td>
      </tr>
      <tr>
