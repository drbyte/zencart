...
define('CROSS_SELL_SUCCESS', 'Cross Sell Items Updated For Cross Sell Product #' . (int)$_GET['add_related_product_ID']);
define('SORT_CROSS_SELL_SUCCESS', 'Sort Order Updated For Cross Sell Product #' . (int)$_GET['add_related_product_ID']);
